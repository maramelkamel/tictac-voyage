...
i18n
  ...
  .init({
    resources: {
      fr: { common: frCommon, navbar: frNavbar, footer: frFooter, contact: frContact, circuits: frCircuits, booking: frBooking, omra: frOmra, destinations: frDestinations, hotels: frHotels },
      ...
      ar: { common: arCommon, navbar: arNavbar, footer: arFooter, contact: arContact, circuits: arCircuits, omra: arOmra, voyages: arVoyages, destinations: arDestinations, hotels: arHotels },
    },
    fallbackLng: 'fr',
    defaultNS: 'common',
