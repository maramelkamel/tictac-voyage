          ...
          <div className="payment-success__card">
            ...
            <p className="payment-success__desc">
              ...
              {method==='agency'
                ...
                : <>Votre paiement de <strong>{totalPrix.toLocaleString('fr-FR')} DT</strong> a été traité. Confirmation envoyée à <strong>{booking.email}</strong>.</>
              }
            </p>
          ...
          <div className="payment-layout">
            <div>
              <div className="payment-total-banner">
                <div>
                  ...
                  <div className="payment-total-banner__sub">{price.toLocaleString('fr-FR')} DT × {personnes} participant{personnes>1?'s':''}</div>
                </div>
                ...
                <div className="payment-card">
                  ...
                  <form className="pay-form" onSubmit={handleOnlineSubmit}>
                    ...
                    <button type="submit" className="payment-submit-btn" disabled={loading}>
                      {loading ? '⏳ Traitement...' : `Payer ${totalPrix.toLocaleString('fr-FR')} DT →`}
                    </button>
                  </form>
                </div>
              )}
              ...
              {method==='agency' && (
                <div className="payment-card payment-card--pink">
                  ...
                  {[{icon:'📍',label:'Adresse',value:'Nouvelle Medina, Tunis'},{icon:'📞',label:'Téléphone',value:'+216 36 149 885'},{icon:'🕐',label:'Horaires',value:'Lun–Ven 09h–18h · Sam 09h–14h'}].map((item,i) => (
                  ...
                  <div className="agency-warning" style={{ marginTop:16 }}>ℹ️ Votre réservation sera retenue <strong>48h</strong>. Présentez-vous à l'agence avec votre confirmation.</div>
            ...
            <aside className="payment-sidebar">
              ...
              <div className="payment-price-card">
                ...
                {[{label:'Prix / participant',value:`${price.toLocaleString('fr-FR')} DT`},{label:`× ${personnes} participant${personnes>1?'s':''}`,value:`${totalPrix.toLocaleString('fr-FR')} DT`},{label:'Taxes & frais',value:'Inclus'}].map((row,i) => (
