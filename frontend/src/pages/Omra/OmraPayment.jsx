        ...
        <div className="payment-success">
          <div className="payment-success__card">
            ...
            <p className="payment-success__desc">
              Merci <strong>{booking.prenom} {booking.nom}</strong> pour votre reservation de{' '}
              <strong>{titre}</strong>.{' '}
              {method === 'agency'
                  ...
                  <form className="pay-form" onSubmit={handleOnlineSubmit}>
                    <div className="pay-field">
                      ...
                      <div className="pay-input-wrapper">
                        ...
                        <span className="pay-input-icon">{cardType}</span>
                      </div>
                    </div>
                    <div className="pay-field">
                    ...
                    <div className="pay-form-row">
                      <div className="pay-field">
                        ...
                        <input className="pay-input" name="billingAddr" type="text" placeholder="Rue, numero..." value={cardForm.billingAddr} onChange={handleCardChange} />
                      </div>
                      <div className="pay-field">
                    ...
                    <div className="payment-security-note">
                      <div>
                        ...
                        <div className="payment-security-note__desc">Vos donnees sont chiffre es via SSL 256-bit.</div>
                      </div>
                    </div>
              ...
              <div className="payment-trip-card">
                ...
                <div className="payment-trip-card__body">
                  ...
                  <div className="payment-trip-card__meta">
                    {[
                      { text: `Depart depuis ${depart}` },
                      { text: duree },
                      { text: `${personnes} voyageur${personnes > 1 ? 's' : ''}` },
                      { text: `Chambre ${booking.chambre}` },
                    ].map((item, index) => (
                      <div key={index} className="payment-trip-card__meta-item">{item.text}</div>
                    ))}
                  </div>
                </div>
              </div>
