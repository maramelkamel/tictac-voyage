                  ...
                  {filtered.map(r => {
                    ...
                    return (
                      <tr key={r.id} className="al-row"
                        ...
                        <td>
                          <span style={{ fontSize:12, fontWeight:600, color:'var(--g700)' }}>{r.voyage_title || '—'}</span>
                          <p style={{ fontSize:10, color:'var(--g400)', marginTop:2 }}>{r.pays} {r.destination?`· ${r.destination}`:''}</p>
                        </td>
                        <td>
