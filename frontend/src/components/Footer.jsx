      ...
      <div className="container">
        ...
        <div style={{ padding: '24px 0', textAlign: 'center' }}>
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', margin: 0 }}>
            ...
            <a href="#" className="footer-bottom-link" style={{ color: 'var(--secondary)', textDecoration: 'none' }}>Mentions légales</a>{' '}
            |{' '}
            <a href="#" className="footer-bottom-link" style={{ color: 'var(--secondary)', textDecoration: 'none' }}>Confidentialité</a>
          </p>
        </div>
      </div>
