...
const navLinks = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        icon: 'fas fa-car',
        title: 'el kelma lo5ra li mana3refhech',
        ...
        <div style={{ padding: '18px 0' }}>
          ...
          >
            ...
            <button
              type="button"
              onClick={() => navigate('/')}
              style={{ display: 'flex', alignItems: 'center', gap: '14px', flexShrink: 0, background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
            >
              <div style={{ fontSize: '20px', fontWeight: 800, color: 'var(--white)', letterSpacing: '-0.02em', lineHeight: 1.2 }}>
                TICTAC VOYAGES
              </div>
              <span style={{ fontSize: '10px', fontWeight: 600, color: 'var(--gold)', letterSpacing: '0.15em', textTransform: 'uppercase', marginLeft: '-10px', marginTop: '2px' }}>
                Agence de Voyage
              </span>
            </button>
                ...
                <div key={link.id} style={{ position: 'relative' }} className="nav-dropdown-wrapper">
                  ...
                  <a
                    ...
                    style={{
                      ...
                      color: 'rgba(255,255,255,0.85)', borderRadius: 'var(--radius-md)',
                      transition: 'all var(--duration) var(--ease)', textDecoration: 'none',
                    }}
                  >
                    {link.label}
                    {link.submenu && (
          ...
          <div key={link.id}>
            ...
            <button
              ...
              style={{
                ...
                width: '100%', padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)',
